            ...
            if match:
                ...
                if re.match('\|', replacement):
                    for k in range(1, len(groups)):
                        replacement = replacement.replace('|' + str(k), cls.str_replace(groups[k - 1], 'ÁÉÍÓÚáéíóú', 'AEIOUaeiou'))
    ...
    def get_singular(cls, word):
        ...
        for rule in rules:
            ...
            if match:
                ...
                if re.match('~', replacement):
                    for k in range(1, len(groups)):
                        replacement = replacement.replace('~' + str(k), cls.str_replace(groups[k - 1], 'AEIOUaeiou', 'ÁÉÍÓÚáéíóú'))
